  ...
  <div>
    ...
    >
      <button
        ...
        :key="tile.id"
        class="group text-left rounded-lg border border-gray-200 dark:border-gray-700 p-4 transition-all duration-200 shadow-sm hover:shadow-md"
        :class="tile.bgColor"
        @click="navigateToFeature(tile.path)"
      >
        <div class="flex items-start justify-between mb-3">
          <div
            class="w-10 h-10 rounded-lg flex items-center justify-center bg-white dark:bg-gray-800 shadow-sm"
          >
            <svg
              class="w-5 h-5"
              :class="tile.color"
        ...
        <h3
          class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-0.5"
        >
          {{ tile.label }}
        </h3>
